...
import gcg.crypto.algorithm.HC256;
...
class HC256Test {
    ...
    void testWriteOneByte() throws IOException, InstantiationException, IllegalAccessException {
        ...
        CryptoOutputStream cos = new CryptoOutputStream(os, KEY, HC256.class);
    ...
    void testReadOneByte() throws IOException, InstantiationException, IllegalAccessException {
        ...
        CryptoInputStream cis = new CryptoInputStream(is, KEY, HC256.class);
